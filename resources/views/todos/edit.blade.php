    ...
    <div class="row">
        ...
        <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div class="container">
                    ...
                    <form id="editTodoForm" action="{{ route('todos.update', $todo->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3" id="imagePreviewContainer" style="display: block;">
                            <img id="imagePreview" src="{{ asset('storage/' . $todo->image) }}" alt="Selected Image" style="max-width: 100%; max-height: 200px;">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="i_is_marked" name="i_is_marked" class="form-select">
                                ...
                                <option value="1" {{ $todo->i_is_marked ? 'selected' : '' }}>Yes</option>
                                <option value="0" {{ !$todo->i_is_marked ? 'selected' : '' }}>No</option>
                            </select>
                        </div>
        
                        <button type="button" id="submitBtn" class="btn btn-primary">Update Todo</button>
                    </form>
...
<!-- todo update submit before Modal -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure you update the details?
            </div>
            <div class="modal-footer">
